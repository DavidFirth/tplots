#' Vote Counts at the United Kingdom General Election of 2024
#'
...
#'   \item{Country.name}{Character string: the name of the constituency's nation within the UK, one of `"England"`, `"Northern Ireland"`, `"Scotland"`, `"Wales"`}
#'   \item{Constituency.type}{Character string: one of `"County"`, `"Burgh"`, `"Borough"`}
...
#'   \item{Member.gender}{Character string: one of `"Male"`, `"Female"`}
...
#'   \item{SF}{Integer: votes for Sinn Féin}
...
#' }
#' @source <https://researchbriefings.files.parliament.uk/documents/CBP-10009/HoC-GE2024-results-by-constituency.csv>, downloaded 28th August 2024.
#'
#' @examples
